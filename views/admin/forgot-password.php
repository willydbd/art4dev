...
<head>
  ...
  <title>Recover Password - Art4Dev</title>
  <!-- Bootstrap core CSS-->
    ...
    <div class="card card-login mx-auto mt-5">
      ...
      <div class="card-body">
        ...
        <form>
          ...
          <a class="btn btn-primary btn-block" href="<?= ADMIN_PREFIX .'login'; ?>">Reset Password</a>
        </form>
        <div class="text-center">
          <a class="d-block small mt-3" href="<?= ADMIN_PREFIX .'register' ?>">Register an Account</a>
          <a class="d-block small" href="<?= ADMIN_PREFIX .'login'; ?>">Login Page</a>
        </div>
      </div>
    </div>
  </div>
